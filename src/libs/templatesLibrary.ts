    ...
    templates: [
      {
        ...
        actionPayload: {
          ...
          examples: [
            {
              text: "Unilever",
              output: "Consumer Goods, Food, Personal Care, Retail",
            },
            { text: "LinkedIn", output: "Social Media, Technology, Business" },
            { text: "FedEx", output: "Logistics, Transportation" },
          ],
        },
      },
      {
        ...
        actionPayload: {
          prompt:
            ...
            "Alliteration:",
          examples: [
            { text: "A person was running to the church.", output: "" },
      ...
      },
      {
        ...
        actionPayload: {
          ...
          examples: [
            {
              text: "Ask RAM Co. if they have new storage units in stock.",
              output: "",
            },
          ],
          tabIndex: TabIndex.multipleExamples,
      ...
      },
      {
        ...
        actionPayload: {
          prompt:
            ...
            "Topic: {example}\n" +
            "Headline:",
          examples: [{ text: "Chicago, restaurants, summer", output: "" }],
          tabIndex: TabIndex.multipleExamples,
          stopSymbols: ["\\n"],
        },
      },
      ...
      },
      {
        ...
        actionPayload: {
          ...
          examples: [
            {
              text: "What is an eigenvector of a linear transformation f?",
              output: "",
            },
            {
              text: "What is the definition of a linear transformation?",
              output: "",
            },
            {
            ...
            {
              text: "What is the maximum number of eigenvalues of an operator on a 5-dimensional vector space?",
              output: "",
            },
            {
      ...
      },
      {
        ...
        actionPayload: {
          prompt:
            ...
            "English: {example}\n" +
            "French:",
          examples: [{ text: "What rooms do you have available?", output: "" }],
          stopSymbols: ["\\n"],
          tabIndex: TabIndex.multipleExamples,
        },
      },
      {
        ...
        actionPayload: {
          prompt:
            ...
            "\t{example}:",
          examples: [{ text: "How much does the iPhone XI cost?", output: "" }],
          stopSymbols: ["\\n"],
          tabIndex: TabIndex.multipleExamples,
        },
      },
    ...
    templates: [
      {
        ...
        actionPayload: {
          prompt:
            "The following is a transcript of a conversation between Steve, a computer science student, " +
